...
@section('content')
    ...
    <div id='active-auctions' class="m-4">
        ...
        <button id="ongoing-button" type="button" class="ms-5 btn btn-dark btn-rounded">See All Ongoing Auctions</button>
    </div>
    <div id='closed-auctions' class="m-4">
        ...
        <button id="closed-button" type="button" class="ms-5 btn btn-dark btn-rounded">See All Recent Auctions</button>
    </div>
@endsection